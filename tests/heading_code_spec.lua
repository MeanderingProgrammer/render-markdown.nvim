...
describe('heading_code.md', function()
    it('default', function()
        ...
        marks:add(row:inc(), nil, 0, nil, util.heading.sign(4))
        marks:add(row:get(), row:get(), 0, 4, util.heading.icon(4))
        marks:add(row:get(), row:inc(), 0, 0, util.heading.bg(4))

        marks:add(row:inc(), nil, 0, nil, util.heading.sign(5))
        marks:add(row:get(), row:get(), 0, 5, util.heading.icon(5))
        marks:add(row:get(), row:inc(), 0, 0, util.heading.bg(5))

        marks:add(row:inc(), nil, 0, nil, util.heading.sign(6))
        marks:add(row:get(), row:get(), 0, 6, util.heading.icon(6))
        marks:add(row:get(), row:inc(), 0, 0, util.heading.bg(6))
        ...
        marks:add(row:get(), row:get(), 3, 9, util.conceal())
